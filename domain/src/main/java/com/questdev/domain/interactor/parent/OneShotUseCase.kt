 ...
 *
 * By convention each [OneShotUseCase] implementation will execute its job in a background thread
 * (kotlin coroutine) and will post the result in the UI thread.
 */
abstract class OneShotUseCase<out Type, in Params> where Type : Any {
